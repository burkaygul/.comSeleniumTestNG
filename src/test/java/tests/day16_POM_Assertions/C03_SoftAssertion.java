...
public class C03_SoftAssertion {
    ...
    public void hardAssertion(){
        ...
        Assert.assertTrue(sayi<1000,"sayi 1000den kucuk olmali"); // sayi 1000 den kucuk mu?
    ...
    public void softAssertionTesti(){
        ...
        // softAsser objesi ile assertion'lari yaptiktan sonra
        // assertAll() kullanmazsaniz, test direkt PASSED olur
