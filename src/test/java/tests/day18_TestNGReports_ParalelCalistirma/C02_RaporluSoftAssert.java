...
public class C02_RaporluSoftAssert  extends TestBaseRapor {
    ...
    public void test01() throws InterruptedException {
        extentTest = extentReports.createTest("Alert Test","Kullanici JS alertleri calistirabilmeli ve kapatabilmeli");
        ...
        extentTest.info("kullanicii herokuapp alerts sayfasina gider");
